...
public class BookControllerMvcTest {
    ...
    void whenGetBookExistingAndAuthenticatedThenShouldReturn200() throws Exception {
        var isbn = "1234123412";
        var expectedBook = Book.of(isbn, "Title", "Author", 9.90, "minseok");
    ...
    void whenDeleteBookWithEmployeeRoleThenShouldReturn204() throws Exception {
        var isbn = "1234123412";
        mockMvc.perform(delete("/books/" + isbn).with(jwt().authorities(new SimpleGrantedAuthority(ROLE_EMPLOYEE))))
    ...
    void whenDeleteBookWithCustomerRoleThenShouldReturn403() throws Exception {
        var isbn = "1234123412";
        mockMvc.perform(delete("/books/" + isbn).with(jwt().authorities(new SimpleGrantedAuthority(ROLE_CUSTOMER))))
    ...
    void whenPostBookWithEmployeeRoleThenShouldReturn201() throws Exception {
        var isbn = "1234123412";
        var bookToCreate = Book.of(isbn, "Title", "Author", 9.90, "minseok");
