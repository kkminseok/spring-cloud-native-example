...
class CatalogServiceApplicationTests {
    ...
    void whenPostRequestThenBookCreated() {
        var expectedBook = Book.of("1231231231", "Title", "Author", 1.10, "minseok");
    ...
    void whenPostRequestUnauthenticatedThen401() {
        var expectedBook = Book.of("1231231232", "Title", "Author", 1.10, "minseok");
    ...
    void whenPostRequestUnauthorizedThen403() {
        var expectedBook = Book.of("1231231233", "Title", "Author", 1.10, "minseok");
    ...
    void whenPutRequestThenBookUpdated() {
        ...
        var bookToCreate = Book.of(bookIsbn, "Title", "Author", 1.10, "minseok");
        ...
        var bookToUpdate = new Book(createdBook.id(), createdBook.isbn(), createdBook.title(), createdBook.author(), 9.99,
